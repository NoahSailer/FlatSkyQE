...
import os,sys
from symlens.factorize import Ldl1,Ldl2,l1,l2,cos2t12,sin2t12,l1x,l2x,l1y,l2y,e,L,Lx,Ly,Lxl1,Lxl2,integrate
import warnings
...
def get_mc_expressions(estimator,XY,field_names=None,estimator_to_harden='hu_ok'):
    ...
    if estimator in hus: # Hu, Okamoto 2001 # Hu, DeDeo, Vale 2007
        ...
        if XY == "TT":
            f = e('pc_T_T_l1')*e('pc_T_T_l2')/e('pc_T_T_L')
            F = f / t1(XY) / t2(XY) / 2
            fr = f
            Fr = F
        elif XY == "EE":
            f = e('pc_T_T_l1')*e('pc_T_T_l2')*cos2t12/e('pc_T_T_L')
            F = f / t1(XY) / t2(XY) / 2
            fr = f
            Fr = F
